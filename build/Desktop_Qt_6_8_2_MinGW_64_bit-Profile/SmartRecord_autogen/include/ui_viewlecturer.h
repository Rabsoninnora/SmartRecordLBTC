...
"};"));
    ...
    void retranslateUi(QDialog *ViewLecturer)
    {
        ...
        lineEdit_Fname->setPlaceholderText(QCoreApplication::translate("ViewLecturer", "Lecturer's First Name", nullptr));
        lineEdit_Mname->setPlaceholderText(QCoreApplication::translate("ViewLecturer", "Middle Name", nullptr));
        lineEdit_Lname->setPlaceholderText(QCoreApplication::translate("ViewLecturer", "Last Name", nullptr));
        lineEdit_NRC->setPlaceholderText(QCoreApplication::translate("ViewLecturer", "Lecturer's NRC#", nullptr));
        lineEdit_Phone->setPlaceholderText(QCoreApplication::translate("ViewLecturer", "Phone Number", nullptr));
        lineEdit_Email->setPlaceholderText(QCoreApplication::translate("ViewLecturer", "Email Address", nullptr));
        lineEdit_Qualification->setPlaceholderText(QCoreApplication::translate("ViewLecturer", "Lecturer's Qualifications", nullptr));
        lineEdit_Physical_Address->setPlaceholderText(QCoreApplication::translate("ViewLecturer", "Physical address", nullptr));
        image_field->setText(QString());
        lineEdit_Lecturer_Department->setPlaceholderText(QCoreApplication::translate("ViewLecturer", "Department", nullptr));
        lineEdit_Lecturer_No_Courses->setPlaceholderText(QCoreApplication::translate("ViewLecturer", "No. OF Courses", nullptr));
        plainTextEdit_Subjects->setPlaceholderText(QCoreApplication::translate("ViewLecturer", "Subjects", nullptr));
