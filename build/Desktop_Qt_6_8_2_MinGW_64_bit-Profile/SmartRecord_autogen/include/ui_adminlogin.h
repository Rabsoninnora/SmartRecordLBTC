...
public:
    ...
    void setupUi(QDialog *Adminlogin)
    {
        ...
        frame->setGeometry(QRect(150, 120, 391, 301));
...
"}"));
        ...
        btn_Admin_login->setGeometry(QRect(50, 250, 81, 31));
...
"}"));
        ...
        lineEdit_username_2->setGeometry(QRect(50, 120, 251, 41));
...
"} "));
        ...
        lineEdit_password_2->setGeometry(QRect(50, 170, 251, 41));
...
"} "));
        ...
        btn_Admin_Cancel->setGeometry(QRect(220, 250, 81, 31));
