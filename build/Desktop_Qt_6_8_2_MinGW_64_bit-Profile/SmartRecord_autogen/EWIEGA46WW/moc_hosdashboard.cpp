...
//case 9: _t->loadCourseData((*reinterpret_cast< std::add_pointer_t<QTableWidget*>>(_a[1]))); break;
        //case 10: _t->loadStudentData((*reinterpret_cast< std::add_pointer_t<QTableWidget*>>(_a[1]))); break;
        default: ;
        }
    }
